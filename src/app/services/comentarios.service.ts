...
export class ComentariosService {
  ...
  mark_comments_as_read_pag(ids: number[]) {
    console.log(ids);
    return this.http.post<any>(this.apiUrl + 'comentarios_paginas/update.php', { ids: ids }, {
      headers: {
  ...
  mark_comments_as_read_prod(ids: number[]) {
    console.log(ids);
    return this.http.post<any>(this.apiUrl + 'comentarios_produtos/update.php', { ids: ids }, {
      headers: {
        'Content-Type': 'application/json'
      }
    });
  ...
  mark_comments_as_read_post(ids: number[]) {
    console.log(ids);
    // Enviar o array de IDs como JSON
    return this.http.post<any>(this.apiUrl + 'comentarios_postagem/update.php', { ids: ids }, {
      headers: {
        'Content-Type': 'application/json'
      }
    });
